...
<tr><td></td></tr>
<tr><td><p style="font-size:25px">호가든(Hoegaarden)</p>
	<p><img src="http://world.moleg.go.kr/oweb/images/countryFlag/BE_L.png" width="30" height="25" float="left"/>     벨기에</p>
...
<td width="65%"><p id="reviewscore">3.75/5</p>
	<p id="reviewdate">당도: 5 | 산미: 2 | 풍미: 4 | 총점: 4</p>
...
<td width="65%"><p id="reviewscore">4.25/5</p>
	<p id="reviewdate">당도: 4 | 산미: 3 | 풍미: 5 | 총점: 5</p>
